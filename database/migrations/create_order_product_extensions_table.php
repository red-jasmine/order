...
return new class extends Migration {
    ...
    {
        Schema::create(config('red-jasmine-order.tables.prefix', 'jasmine_').'order_product_extensions', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists(config('red-jasmine-order.tables.prefix', 'jasmine_').'order_product_extensions');
    }
};
