...
use RedJasmine\Order\Domain\Order\Models\ValueObjects\Price;

class OrderProductMapper
{


    public function fromData(OrderProductData $orderProductData) : OrderProduct
    {
        ...
        //$orderProduct->price                  = new Price($orderProductData->price);
