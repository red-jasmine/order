...
namespace RedJasmine\Order\Services\Orders\Validators;
...
class OrderValidate
{
    ...
    public function rules() : array
    {
        $order   = [
            ...
            'is_seller_delete'    => [ 'required', 'integer', 'min:0', 'max:255' ],
            'is_buyer_delete'     => [ 'required', 'integer', 'min:0', 'max:255' ],
        ...
        $product = [
            ...
            'oid'                    => [ 'required', 'integer', 'min:0', 'max:18446744073709551615' ],
            'shipping_type'          => [ 'required', 'string', 'min:1', 'max:30' ],
            'title'                  => [ 'nullable', 'string', 'min:1', 'max:255' ],
            ...
            'discount_amount'        => [ 'required', 'numeric' ],
            'payment_amount'         => [ 'required', 'numeric' ],
            'divide_discount_amount' => [ 'required', 'numeric' ],
            'divided_payment_amount' => [ 'required', 'numeric' ],
            'refund_amount'          => [ 'required', 'numeric' ],
            'cost_amount'            => [ 'required', 'numeric' ],
            'order_status'           => [ 'required', 'string', 'min:1', 'max:255' ],
            'shipping_status'        => [ 'nullable', 'string', 'min:1', 'max:30' ],
