...
namespace RedJasmine\Order\Services\Order\Validators;

use RedJasmine\Support\Foundation\Service\Actions\ValidatorCombiner;

class OrderCreateValidator extends ValidatorCombiner
{
    ...
    public function rules() : array
    {
        $order = [
            ...
            'order_status'        => [ 'nullable', 'string', 'min:1', 'max:255' ],
            ...
            'collect_time'        => [ 'nullable', 'date' ],
            'dispatch_time'       => [ 'nullable', 'date' ],
            'signed_time'         => [ 'nullable', 'date' ],
            'end_time'            => [ 'nullable', 'date' ],
            'refund_time'         => [ 'nullable', 'date' ],
            'rate_time'           => [ 'nullable', 'date' ],
