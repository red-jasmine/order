 ...
 */
class OrderProductSellerRemarksAction extends AbstractOrderProductAction
{
    ...
    public function handle() : Model
    {
        ...
        if ($this->data->isAppend) {
            $orderProduct->info->seller_remarks .= "\n" . $this->data->remarks;
        } else {
            $orderProduct->info->seller_remarks = $this->data->remarks;
        }
        $orderProduct->push();
        return $orderProduct;
    }
