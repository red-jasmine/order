...
class OrderTransformer
{
    public function transform(OrderData $orderData, ?Order $order = null) : Order
    {
        ...
        $order->extension->seller_expands = $orderData->sellerExpands;
        $order->extension->buyer_expands  = $orderData->buyerExpands;
        $order->extension->other_expands  = $orderData->otherExpands;
    ...
    public function transformProduct(
        ...
        $orderProduct->extension->seller_expands       = $orderProductData->sellerExpands;
        $orderProduct->extension->buyer_remarks        = $orderProductData->buyerExpands;
        $orderProduct->extension->other_expands        = $orderProductData->otherExpands;
